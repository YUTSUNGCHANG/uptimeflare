...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: 'Myip',
      method: 'GET',
      target: 'https://myip.ytcapp.eu.org/',
      tooltip: '查詢我的ＩＰ',
      statusPageLink: 'https://myip.ytcapp.eu.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Alert',
      method: 'GET',
      target: 'https://alert.ytcapp.eu.org/',
      tooltip: '訂閱管理系統',
      statusPageLink: 'https://alert.ytcapp.eu.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Splunk',
      method: 'GET',
      target: 'https://splunk.ytcweb.eu.org/',
      tooltip: 'Log收集',
      statusPageLink: 'https://splunk.ytcweb.eu.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },    
